...
class Bottle(pygame.sprite.Sprite):
    def __init__(self, position):  
        ...
        self.rect = self.image.get_rect()
        self.rect.topleft = position # (720,602)
...
class Game(pygame.sprite.Sprite):
    ...
    def __init__(self): 
     ...
     #   self.sprites = interactions
        ...
        self.broken.add(self.player)  # need? check
    ...
    # we will use this class to add movement to the player
        ...
        while self.game_play == True:
            ...
            self.hits = pygame.sprite.groupcollide(self.broken,self.bottles,True,True)  # groupcollide   collided = None
            if self.hits:
                self.hitSound.play()
            ...
            self.hits = pygame.sprite.spritecollide(self.player,self.enemies,True,pygame.sprite.collide_circle)
            for hit in self.hits:
                ...
                if self.hits == False:
                    ...
                    self.hits = self.broken.pygame.sprite.empty()
